...
export type CompletionStatus = "ToDo" | "Doing" | "Done";
export interface DateTime extends std.$Object {
  "created": Date;
  "modified": Date;
}
export interface Epic extends DateTime {
  "description": string;
  "points"?: number | null;
...
export interface Project extends DateTime {
  "epics": Epic[];
  "description": string;
  "name": string;
  "stories": UserStory[];
...
export interface UserStory extends DateTime {
  "action": string;
  "benefit": string;
  "description": string;
  "points"?: number | null;
